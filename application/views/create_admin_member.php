			...
			<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
				<div class="d-table-cell align-middle">
					...
					<div class="card">
						<div class="card-body">
							<div class="m-sm-4">
								<form action="/CreateAdminMember/insert_admin_member" method="post">
									<div class="mb-3">
										<input class="form-control form-control-lg" type="text" name="user_id" placeholder="USERID ( 생성할 유저 아이디 )" required/>
									</div>
									<div class="mb-3">
