	...
	$.jstree.core.prototype = {
      ...
      if (obj && $.inArray(obj.id, this._model.changed) === -1) {
		...
		rename_node : function (obj, val) {
			...
			// rename_node
			// rename_node
			var data = {"cate_id" : obj.id, "cate_kor" : val};
			$.ajax({
				url: "/configs/rename_cate_kor",
				dataType: 'json',
				type: "POST",
				async: false,
				data: data,
		...
		move_node : function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
			...
			if(obj.parent === new_par.id) {
				...
				// 부모카테고리가 변경되는 경우 하위카테고리가 없을 경우에만 변경 가능!!!
			...
			if(callback) { callback.call(this, obj, new_par, pos); }
				...
				$.each(jsonNodes, function (i, val) {
				     if(new_par.id==val.parent) {
						cate_list.push(val.id);
					 }  
				});				
				...
				// 카테고리 이동하기 
				var data = {"parents_id" : new_par.id, "cate_id" : obj.id, "cate_list" : cate_list};
				$.ajax({
					url: "/configs/change_parents_category",
					dataType: 'json',
					type: "POST",
					async: false,
					data: data,
			...
			h2 = $("<"+"input />", {
						...
						"blur" : function (e) {
							...
							var i = s.children(".jstree-rename-input"),
								...
								console.log(this.settings.core);
			...
			return {
				"create" : {
					...
					"action"			: function (data) {
						...
						inst.create_node(obj, {}, "last", function (new_node) {
							try {
								inst.edit(new_node);
								var data = {"parents_id" : new_node.parent, "new_id" : new_node.id};
								$.ajax({
									url: "/configs/add_sub_category",
									dataType: 'json',
									type: "POST",
									async: false,
									data: data,
				...
				"remove" : {
					...
					"action"			: function (data) {
						...
						var data = {"now_id" : obj.original.id}
						$.ajax({
						url: "/configs/delete_category",
						dataType: 'json',
						type: "POST",
						async: false,
						data: data,
